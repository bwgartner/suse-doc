...
:OSDNic: MCX516A-CCAT Dual Port 100GbE
...
= SUSE(R) Enterprise Storage on {vendor}(R) {vplatform}
...
* 7300 NVMe SSDs leverage the low power consumption and price-performance efficiencies of 3D NAND technology and deliver fast NVMe IOPS and GB/s for a wide array of workloads.
