...
+
TIP: As a reference for what you just deployed, visit https://kubernetes.io/docs/tutorials/stateful-application/mysql-wordpress-persistent-volume/[Deploying WordPress and MySQL with Persistent Volumes].
+
...
----
+
. Now you can now quit "q" the text-based `w3m` browser and stop all of these deployed components, via
+
[subs="attributes"]
----
fg
